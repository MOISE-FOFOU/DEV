...
const test = base.extend({
    page: async ({ browser }, use) => {
      ...
      await page.getByPlaceholder('name@mail.com').fill(jsonData.username);
      await page.getByPlaceholder('********').fill(jsonData.pwd);
      await page.getByRole('button', { name: 'Connectez-vous' }).click();
